...
Hi!👋🏼 My name is Kristy and I'm a third-year Ph.D. student in [Computer Science](https://www.cs.umd.edu/people/kvsakano) at the University of Maryland, College Park, advised by [Dr. Mumu Xu](https://user.eng.umd.edu/~mumu/) of the Department of Aerospace Engineering. I'm also part of the [GAMMA Lab in the Department of Computer Science](https://gamma.umd.edu/) which is where you'll find me most days.
...
This past summer (2026), I interned at the [Department of Transportation Highly Automated Systems Safety Center of Excellence](https://www.transportation.gov/hasscoe) (DOT HASS COE), where I developed a pruning and matching algorithm for historical autonomous vehicle (AV) crash data from the NHTSA SGO and the California DMV. We conducted exploratory data analysis to identify trends that could support automated crash typology classification and integrate the two datasets, providing a more comprehensive understanding of the circumstances leading up to AV crashes. This work ultimately aims to identify gaps in our understanding of AV safety and inform efforts to prevent future crashes.
...
One fun fact: during my undergrad, I conducted research at the Harvard-Smithsonian Center for Astrophysics through a Smithsonian-funded program, studying pulsating star systems. That work remains my [most cited paper to date](https://scholar.google.com/citations?view_op=view_citation&hl=en&user=6ytFsFEAAAAJ&citation_for_view=6ytFsFEAAAAJ:u-x6o8ySG0sC) 🌟
